...
# --- Inputs de usuario ---
a = st.number_input("Límite inferior a", value=-6.0)
b = st.number_input("Límite superior b", value=6.0)
n = st.number_input("Número de muestras n", min_value=1, value=50, step=1)
opcion = st.radio("Seleccione función f(x):", ("Opción a", "Opción b"))
